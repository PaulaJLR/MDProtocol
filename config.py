...
class RestraintConfig:
    ...
    minim_posres_lig_anc_weight: Quantity = 10.0 * kilocalories_per_mole/angstroms**2
    minim_posres_lig_ext_weight: Quantity = 10.0 * kilocalories_per_mole/angstroms**2
    ...
    posres_lig_anc_weight: Quantity = 10.0 * kilocalories_per_mole/angstroms**2
    posres_lig_ext_weight: Quantity = 5.0 * kilocalories_per_mole/angstroms**2
    ...
    def posres_lig_anc_mask(atom, lig_anchor_atoms):
        return(
            atom.residue.name == 'LIG' and
            atom.name in lig_anchor_atoms
        )
    
    def posres_lig_ext_mask(atom, lig_anchor_atoms):
        return(
            atom.residue.name == 'LIG' and
            atom.element.symbol != "H" and
